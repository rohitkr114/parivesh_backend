...
@Slf4j
@Service
public class CrzRecommendationCertificateService {
	...
	@Transactional
	public Object saveCrzRecommendationCertificate(CrzGrantCertificate crzGrantCertificate, HttpServletRequest request,
...
//        EnvironmentClearence environmentClearence = environmentClearenceRepository.findByProposalNo(standardTorCertificate.getProposal_No());
	...
	public CertProposalDetailInfo getCrzRecommendationCertDetails(int propId, String proposalNo) throws ParseException {
