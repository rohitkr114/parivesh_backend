...
@Service
@Slf4j
public class FcIROStageClearanceCertificateService {
    ...
    @Autowired
    FcIROStageClearanceCertificateRepository fcIROStageClearanceCertificateRepository;
    ...
    public Object saveFcIROStageClearanceCertificate(FcIROStageClearanceCertificate fcIROStageClearanceCertificate, HttpServletRequest request) throws IOException {

        log.info("==================Calling Save API for FcIROStageClearanceCertificate ========================");
        FcIROStageClearanceCertificate fcIROStageClearanceCertificateResult = null;
        //Maintaining History
        if (fcIROStageClearanceCertificateRepository.existsById(fcIROStageClearanceCertificate.getId())) {
            ...
            Optional<FcIROStageClearanceCertificate> fcIROStageClearanceCertificate1 = fcIROStageClearanceCertificateRepository.findById(fcIROStageClearanceCertificate.getId());
        ...
        String fileName = FileUploadUtil.fileNameMaker("fc_iro_stage_ii_clearance_" + String.valueOf(new java.util.Date().getTime()) + String.valueOf(new java.util.Date().getDate()) + "_" +convertedProposalNo + "_" + fcIROStageClearanceCertificate.getProponentId(), "pdf");
    ...
    public FcIROStageClearanceCertificate getAllDataByPropId(int propId, String proposalNo, String officeType) {
        log.info("==============================getting FcIROStageClearanceCertificate detail by ProId===========================");

        FcIROStageClearanceCertificate fcIROStageClearanceCertificate;
        fcIROStageClearanceCertificate = fcIROStageClearanceCertificateRepository
                .getFcIROStageClearanceCertificateInfoBytPropId(propId, proposalNo);

        if (!ObjectUtils.isEmpty(fcIROStageClearanceCertificate)) {

            return fcIROStageClearanceCertificate;
        }
        fcIROStageClearanceCertificate=new FcIROStageClearanceCertificate();
        ProponentApplications proponentApplications = proponentApplicationRepository
        ...
        fcIROStageClearanceCertificate.setState(stateNameP);
        ...
        List<String> division = fcIROStageClearanceCertificateRepository.getDivision(propId);
      ...
      //Adding area and state file number
		...
		fcIROStageClearanceCertificate.setThreshold(fcMinistryStageClearanceCertificateRepository.getThreshold(propId));
