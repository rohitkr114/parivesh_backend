...
@Data
@NoArgsConstructor
public class EnvironmentClearanceProjectActivityDetailsDto {
	...
	public EnvironmentClearanceProjectActivityDetailsDto(Integer id, Integer ac_id, String name, boolean is_active,
