...
@Data
@Entity
@Table(name="fc_form_c_part_b_enumeration_details", schema="master")
public class FcFormCPartBEnumerationDetails extends Auditable<Integer>{
	...
	public FcFormCPartBEnumerationDetails() {
		this.is_active=true;
