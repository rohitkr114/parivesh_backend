...
@Data
@Entity
@Table(name = "ec_form8_undertaking", schema = "master")
public class EcForm8Undertaking  extends Auditable<Integer> {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Integer id;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ec_form_8_id", nullable = true)
    @JsonIgnore
    ...
    public EcForm8Undertaking() {
        this.is_active = true;
        this.is_delete = false;
    }

    public EcForm8Undertaking(Integer id, boolean i_agree, String undertaking_person_name,
