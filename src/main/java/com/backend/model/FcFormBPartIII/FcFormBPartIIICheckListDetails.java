...
@Data
@Entity
@Table(name="fc_form_B_part_III_checklist_details", schema="authority")
public class FcFormBPartIIICheckListDetails extends Auditable<Integer> {
...
//	/** Combined (DFL & NFL] **/
	...
	@OneToOne(mappedBy = "formBPartIIIChecklistDetails")
	private FcFormBPartIIIProjectDetails fcFormBPartIIIprojectDetails;
	...
	public FcFormBPartIIICheckListDetails() {
		this.is_active = true;
