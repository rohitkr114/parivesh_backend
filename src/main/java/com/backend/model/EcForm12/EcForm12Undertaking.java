...
@Data
@Entity
@Table(name = "ec_form12_undertaking", schema = "master")
public class EcForm12Undertaking {
	...
	public EcForm12Undertaking() {
		this.is_active = true;
		this.is_delete = false;
	}

	public EcForm12Undertaking(Integer id, boolean i_agree, String undertaking_person_name,
	...
	public EcForm12Undertaking(Integer id) {
		this.id = id;
	}
