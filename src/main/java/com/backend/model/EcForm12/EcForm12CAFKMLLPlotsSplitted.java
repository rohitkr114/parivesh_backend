...
@Data
@Entity
@Table(name = "ec_form_12_caf_kml_plots_splitted", schema = "master")
public class EcForm12CAFKMLLPlotsSplitted extends Auditable<Integer> {
    ...
    public EcForm12CAFKMLLPlotsSplitted() {
        this.is_active = true;
