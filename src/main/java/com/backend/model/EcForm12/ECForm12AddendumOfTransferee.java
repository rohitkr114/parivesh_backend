...
@Data
@Entity
@Table(name = "ec_form_12_addendum_of_transferee", schema = "master")
public class ECForm12AddendumOfTransferee {
    @Id
    ...
    private String transferee_company_name;
    ...
    public ECForm12AddendumOfTransferee() {
        this.is_active = true;
