...
@Data
@Entity
@Table(name="fc_form_D_part_III_checklist_details", schema="authority")
public class FcFormDPartIIICheckListDetails extends Auditable<Integer> {
...
//	/** Combined (DFL & NFL] **/
	...
	@OneToOne(mappedBy = "formDPartIIIChecklistDetails")
	private FcFormDPartIIIProjectDetails fcFormDPartIIIprojectDetails;
	...
	public FcFormDPartIIICheckListDetails() {
		this.is_active = true;
