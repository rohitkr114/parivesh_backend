...
@Data
@Entity
@Table(name = "ec_mining_amendment_certificate", schema = "master")
public class EcMiningAmendmentCertificate extends Auditable<Integer> {
    ...
    @Column(name = "detailOfPriorEc", length = 1000, nullable = true)
    private String detailOfPriorEc;
    ...
    private Boolean reasonForAmendment;

    @OneToMany(targetEntity = EcMiningAmendmentCertificateAdditionalCondition.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_mining_amendment_certificate_additional_certificate_id", referencedColumnName = "id")
    private Set<EcMiningAmendmentCertificateAdditionalCondition> additionalConditions = new HashSet<>();

    @OneToMany(targetEntity = EcMiningAmendmentCertificatePlantAmendment.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_mining_amendment_certificate_plant_amendment_id", referencedColumnName = "id")
    private Set<EcMiningAmendmentCertificatePlantAmendment> plantAmendments = new HashSet<>();
