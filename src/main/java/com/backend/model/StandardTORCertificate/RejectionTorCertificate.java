...
@Data
@Entity
@Table(name = "rejection_tor_certificate", schema = "master")
public class RejectionTorCertificate extends Auditable<Integer> {
    ...
    @Column(name = "standardPara", length = 1500000, nullable = true)
    ...
    @OneToMany(targetEntity = RejectionTorCertificatePlantEquipment.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "rejection_tor_certificate_plant_equipment_id", referencedColumnName = "id")
    private List<RejectionTorCertificatePlantEquipment> plantEquipmentArray = new ArrayList<>();

    @OneToMany(targetEntity = RejectionTorCertificateDetailOfProduct.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "rejection_tor_certificate_detail_of_product_id", referencedColumnName = "id")
    private List<RejectionTorCertificateDetailOfProduct> detailsOfProducts = new ArrayList<>();
