...
@Data
@Entity
@Table(name = "ec_tor_transfer_template", schema = "master")
public class EcTorTransferTemplate extends Auditable<Integer> {
    ...
    @Column(name = "statusOfImplementationProject", length = 1000, nullable = true)
    private String statusOfImplementationProject;

    @Column(name = "detailsOfTransferee", length = 1000, nullable = true)
    private String details_of_transferee;

    @Column(name = "detailsOfTransferer", length = 1000, nullable = true)
