...
@Data
@Entity
@Table(name = "ec_transfer_template", schema = "master")
public class EcTransferTemplate extends Auditable<Integer> {
    ...
    @Column(name = "detailsOfTransferor", length = 1000, nullable = true)
    ...
    @Column(name = "ecValidity", length = 1000, nullable = true)
    private String  ecValidity;
    @Column(name = "registeredAddress", length = 1000, nullable = true)
    private String registeredAddress;

    @Column(name = "additionalTerm", length = 1000000, nullable = true)
