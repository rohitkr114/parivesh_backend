...
@Data
@Entity
@Table(name = "ec_mining_transfer_certificate", schema = "master")
public class EcMiningTransferCertificate extends Auditable<Integer> {
    ...
    @Column(name = "additionalTerm", columnDefinition = "text", nullable = true)
