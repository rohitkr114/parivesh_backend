...
@Data
@Entity
@Table(name = "ec_tor_amendment_certificate", schema = "master")
public class EcTorAmendmentCertificate extends Auditable<Integer> {
    ...
    @Column(name = "detailOfPriorTor", length = 1000, nullable = true)
    private String detailOfPriorTor;
    ...
    @OneToMany(targetEntity = EcTorAmendmentCertificateReasonAmendment.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_tor_amendment_certificate_reason_amendment_id", referencedColumnName = "id")
    private Set<EcTorAmendmentCertificateReasonAmendment> reasonForAmendmentArray = new HashSet<>();

    @OneToMany(targetEntity = EcTorAmendmentCertificatePlantEquipment.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_tor_amendment_certificate_plant_equipment_id", referencedColumnName = "id")
    private Set<EcTorAmendmentCertificatePlantEquipment> plantEquipmentArray = new HashSet<>();

    @OneToMany(targetEntity = EcTorAmendmentCertificateDetailOfProduct.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_tor_amendment_certificate_detail_of_product_id", referencedColumnName = "id")
    private Set<EcTorAmendmentCertificateDetailOfProduct> detailsOfamendment = new HashSet<>();
