...
@NoArgsConstructor
@Entity
@Table(name = "rejection_tor_certificate_detail_of_product", schema = "master")
public class RejectionTorCertificateDetailOfProduct {
    ...
    public RejectionTorCertificateDetailOfProduct(String name_of_the_product, String byProduct, Double quantity, String unit, String mode_of_transport, String remarks, Double proposed_quantity, String quantity_total) {
