...
@Data
@Entity
@Table(name = "ec_mining_fresh_letter_certificate", schema = "master")
public class EcMiningFreshLetterCertificate extends Auditable<Integer> {
    ...
    @Column(name = "ec_validity", length = 100, nullable = true)
    ...
    @Column(name = "standardEcConditions", length = 1000, nullable = true)
    private String standardEcConditions;

    @Column(name = "specificEcConditions", length = 1000, nullable = true)
    ...
    @Column(name = "need_of_project", length = 1000, nullable = true)
    private String need_of_project;
    
    @Column(name = "dateOfSubmission", length = 1000, nullable = true)
    ...
    @OneToMany(targetEntity = EcMiningFreshLetterCertificateDetailOfMinerals.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_mining_fresh_letter_certificate_detail_of_minerals_id", referencedColumnName = "id")
    ...
    @OneToMany(targetEntity = EcMiningFreshLetterCertificateStandardConditions.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_mining_fresh_letter_certificate_standard_condition_id", referencedColumnName = "id")
    private Set<EcMiningFreshLetterCertificateStandardConditions> standardConditions = new HashSet<>();

    @OneToMany(targetEntity = EcMiningFreshLetterCertificateSpecificConditions.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "ec_mining_fresh_letter_certificate_specific_condition_id", referencedColumnName = "id")
