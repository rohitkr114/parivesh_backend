...
@Data
@Entity
@Table(name = "standard_tor_certificate", schema = "master")
public class StandardTorCertificate extends Auditable<Integer> {
    ...
    @OneToMany(targetEntity = StandardTorCertificatePlantEquipment.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "standard_tor_certificate_plant_equipment_id", referencedColumnName = "id")
    private List<StandardTorCertificatePlantEquipment> plantEquipmentArray = new ArrayList<>();

    @OneToMany(targetEntity = StandardTorCertificateDetailOfProduct.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "standard_tor_certificate_detail_of_product_id", referencedColumnName = "id")
