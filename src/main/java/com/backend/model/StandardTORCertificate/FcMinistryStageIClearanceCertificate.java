...
@Data
@Entity
@Table(name = "fc_Ministry_stagei_clearance_certificate", schema = "master")
public class FcMinistryStageIClearanceCertificate extends Auditable<Integer> {
    ...
    @Lob
    @Column(name="compliance_report_value",nullable = true)
    private String complainceReportValue;
