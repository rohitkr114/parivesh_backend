...
@Data
@Entity
@Table(name="fc_form_C_part_III_checklist_details", schema="authority")
public class FcFormCPartIIICheckListDetails extends Auditable<Integer>  {
...
//	/** Combined (DFL & NFL] **/
	...
	@OneToOne(mappedBy = "formCPartIIIChecklistDetails")
	private FcFormCPartIIIProjectDetails fcFormCPartIIIprojectDetails;
	...
	public FcFormCPartIIICheckListDetails() {
		this.is_active = true;
