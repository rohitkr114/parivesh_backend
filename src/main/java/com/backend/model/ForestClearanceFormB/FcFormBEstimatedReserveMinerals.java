...
@Data
@Entity
@Table(name="fc_form_b_estimated_reserve_minerals",schema = "master")
public class FcFormBEstimatedReserveMinerals extends Auditable<Integer> {
	...
	public FcFormBEstimatedReserveMinerals() {
		this.is_active=true;
