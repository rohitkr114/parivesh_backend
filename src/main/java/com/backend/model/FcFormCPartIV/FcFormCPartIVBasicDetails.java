package com.backend.model.FcFormCPartIV;
...
@Data
@Entity
@Table(name = "fc_form_C_part_IV_basic_details", schema = "authority")
public class FcFormCPartIVBasicDetails extends Auditable<Integer> {
	...
	public FcFormCPartIVBasicDetails() {
		this.is_active = true;
