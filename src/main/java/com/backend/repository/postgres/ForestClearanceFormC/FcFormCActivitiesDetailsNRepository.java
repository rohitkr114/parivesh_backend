...
import com.backend.model.ForestClearanceFormC.FcFormCActivitiesDetailsN;

public interface FcFormCActivitiesDetailsNRepository extends JpaRepository<FcFormCActivitiesDetailsN, Integer>{

	@Query(" select  new FcFormCActivitiesDetailsN( id"
	...
	@Query("select new FcFormCActivitiesDetailsN(id) from FcFormCActivitiesDetailsN where fc_form_c_id=?1")
